            ...
            <div style={{
                ...
                <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.25)', marginTop: '0.35rem', marginLeft: '0.25rem' }}>
                    ...
                    {searchParams?.message && (
                        <div style={{
                            ...
                            background: searchParams.message.includes('creada')
                                ...
                                : 'rgba(244,63,94,0.08)',
                            border: `1px solid ${searchParams.message.includes('creada') ? 'rgba(37,211,102,0.2)' : 'rgba(244,63,94,0.2)'}`,
                            color: searchParams.message.includes('creada') ? '#25D366' : '#fb7185',
                            fontSize: '0.85rem',
                            borderRadius: '0.75rem',
                            textAlign: 'center',
                        }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: '0.25rem' }}>
                        ...
                        <span style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.25)', fontWeight: 600, letterSpacing: '0.05em', whiteSpace: 'nowrap' }}>
                            ¿YA TIENES CUENTA?
                        </span>
                        <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.06)' }} />
                    </div>
